...
**Live:** [https://relaxed-weasel-snipe-it.cloud.nexlayer.ai](https://relaxed-weasel-snipe-it.cloud.nexlayer.ai)  
...
**snipe-it** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/snipe/snipe-it:latest
    path: /
    servicePorts:
    - 80
    vars:
      APP_URL: "https://relaxed-weasel-snipe-it.cloud.nexlayer.ai"
      MYSQL_PORT_3306_TCP_ADDR: "mysql.pod"
      MYSQL_DATABASE: snipeit
      MYSQL_USER: snipeit
      MYSQL_PASSWORD: "${MYSQL_PASSWORD}"
      APP_KEY: "base64:SNIPEITkeyHere123456789XXXXXXXx="
  - name: mysql
